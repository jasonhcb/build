...
ajx_a = 'a'
ajx_comt = 'comments'
ajx_submit_form = '.comment-form'
ajx_comtlist = '.commentlist'
ajx_comtpagenav = '.page_navi'
ajx_comtpagenav_a = '.page_navi a'
ajx_sform = '#searchform'
ajx_skey = '#s';
add_loading();
...
function ajax(reqUrl, msg, method, data) {
  if (msg == 'pagelink' || msg == 'search') {
    ...
    $(ajx_comtlist).fadeTo('0', 1);
    $(ajx_comtpagenav).fadeTo('0', 1);
  }
  $.ajax({
    url: reqUrl,
    type: method,
    ...
    success: function (data) {
      if (msg == 'pagelink' || msg == 'search') {
        ...
        $('#' + ajx_comt).html($(data).find('#' + ajx_comt).html());
        $('#' + ajx_comt).fadeTo('0', 1);
        $('body,html').animate({
          scrollTop: $('#' + ajx_comt).offset().top
        }, 600);
      } else if (msg == 'comtpagenav') {
        ...
        $(ajx_comtpagenav).fadeTo('0', 1);
        $('body,html').animate({
          scrollTop: $(ajx_comtlist).offset().top
        }, 0);
      }
    ...
    complete: function () {
      ...
      window.load = reload_func();
      $('.sybg').on('click', function () {
        $('#search-2').slideToggle(250)
      });
    },
    timeout: 5000,
    error: function (request) {
      if (msg == msg == 'pagelink' || msg == 'search') {
        ...
        $('#' + ajx_comt).fadeTo('50', 1);
      } else if (msg == 'comtpagenav') {
        $(ajx_comtlist).fadeTo('50', 1);
        $(ajx_comtpagenav).fadeTo('50', 1);
      } else {
        location.href = reqUrl;
      }
    },
